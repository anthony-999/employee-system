...
<body>
    ...
    <div class="content-wrapper">
        <div class="head-content">
            ...
            <div class="search">
                <form action="/employee-system/result.php" method="get">
                    <input type="text" name="search" id="search" placeholder="ID or First/Last Name">
        ...
        <div class="employee">
            <table>
                ...
                <?php while ($results = mysqli_fetch_array($sqlEmployee)) { ?>
                    <tr>
                        ...
                        <td id="action">
                            <form action="/employee-system/update.php" method="post">
                                ...
                                <input type="hidden" name="edit_firstname" value="<?php echo $results['firstName']; ?>">  
                                <input type="hidden" name="edit_lastname" value="<?php echo $results['lastName']; ?>">  
                                <input type="hidden" name="edit_middlename" value="<?php echo $results['middleName']; ?>"> 
                                <input type="hidden" name="edit_age" value="<?php echo $results['age']; ?>">  
                                <input type="hidden" name="edit_birthdate" value="<?php echo $results['birthdate']; ?>">  
                                <input type="hidden" name="edit_gender" value="<?php echo $results['gender']; ?>">  
                                <input type="hidden" name="edit_address" value="<?php echo $results['address']; ?>">  
                                <input type="hidden" name="edit_contact" value="<?php echo $results['contact']; ?>">   
                                <input type="hidden" name="edit_position" value="<?php echo $results['position']; ?>">
                                <input type="hidden" name="edit_NBI" value="<?php echo $results['NBI']; ?>">   
                                <input type="hidden" name="edit_SSS" value="<?php echo $results['SSS']; ?>">   
                                <input type="hidden" name="edit_my_PagIBIG" value="<?php echo $results['PAG_IBIG']; ?>">                                                              
                            </form> 
